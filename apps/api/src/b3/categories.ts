...
const TICKER_PRIMARY_NAME: Record<string, string> = {
  ...
  PRIO3: 'PetroRio', RECV3: 'Recôncavo', BRAV3: 'Brava Energia',
  ...
  BHIA3: 'Casas Bahia', ASAI3: 'Assaí', PCAR3: 'Grupo Pão de Açúcar',
  CRFB3: 'Carrefour', SOMA3: 'Grupo Soma', AZZA3: 'Arezzo',
  ...
  // Energia
  AXIA3: 'Axia Energia', AXIA6: 'Axia Energia', ENGI11: 'Energisa',
  ...
  SAPR4: 'Sanepar', SAPR3: 'Sanepar', IGUA3: 'Iguá Saneamento',
  // Tecnologia
  ...
  AMZO34: 'Amazon', NVDC34: 'Nvidia',
  TSLA34: 'Tesla', NFLX34: 'Netflix',
  // Saúde
  ...
  ONCO3: 'Oncoclínicas', MATD3: 'Mater Dei', AALR3: 'Alliar',
};
...
const TICKERS_BY_CATEGORY: Record<Category, string[]> = {
  ...
  commodities: [
    ...
    'PRIO3', 'RECV3', 'BRAV3', 'UGPA3', 'VBBR3',
    'AGRO3', 'SLCE3', 'SMTO3', 'CAML3', 'JALL3', 'TTEN3',
    'GOLD11', 'HASH11',
  ],
  varejo: [
    'MGLU3', 'LREN3', 'AMER3', 'BHIA3', 'ASAI3', 'PCAR3', 'CRFB3',
    'SOMA3', 'AZZA3', 'VIVA3', 'CEAB3', 'AMAR3', 'ALPA4', 'GRND3',
    'NTCO3', 'SMFT3', 'ESPA3', 'LWSA3',
    'MEAL3', 'FHER3',
  ],
  energia: [
    'AXIA3', 'AXIA6', 'ENGI11', 'EGIE3', 'CPFE3', 'TAEE11', 'TAEE4',
    'CMIG4', 'CMIG3', 'CPLE6', 'CPLE3', 'AURE3', 'ENEV3', 'CESP3',
    'ENBR3', 'EQTL3', 'NEOE3', 'AESB3', 'ISAE4', 'BTLG11',
  ],
  saneamento: [
  ...
  tecnologia: [
    ...
    'AAPL34', 'MSFT34', 'GOGL34', 'AMZO34', 'NVDC34',
    'TSLA34', 'NFLX34',
    'NASD11', 'SPXI11', 'IVVB11',
  ],
  saude: [
    'RDOR3', 'HAPV3', 'FLRY3', 'DASA3', 'GNDI3', 'QUAL3', 'PARD3',
    'BLAU3', 'ODPV3', 'ONCO3', 'MATD3', 'AALR3',
